...
Parameters:
	...
	4: _viewDistance <NUMBER> - This is the static overall viewDistance, can be set by (KISKA_VD_viewDist)
								This is static because it doesn't affect FPS too much.
	5: _increment <NUMBER> - The amount the viewDistance can incriment up or down each cycle (KISKA_VD_inc)
